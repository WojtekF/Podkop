...
///     and the one-past-the-limit next-page signal mirror the durable store's contract; saving is
///     a no-op because mutations on the held aggregates (the comment count the contract event
///     moves) are already visible in place.
/// </summary>
