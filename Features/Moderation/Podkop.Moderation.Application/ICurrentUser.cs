...
/// <summary>
///     The identity every report interaction acts as. Until real authentication exists this is a
...
///     owns its own current-user port (ADR 0003); this is the Moderation slice's. Real auth
